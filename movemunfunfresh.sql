...
--
-- Host: localhost
-- Generation Time: Oct 13, 2025 at 07:31 AM
...
INSERT INTO `game` (`game_id`, `game_name`, `game_description`, `part1`, `part2`, `part3`, `part4`, `part5`) VALUES
(1, 'handmade', 'kuybest', 20, 20, 20, 20, 20);
...
CREATE TABLE `play` (
  ...
  `play_time` char(5) NOT NULL,
  `time_spent_playing` time NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
